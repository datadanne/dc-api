...
export const { AIRSTACK_API_KEY } = process.env;
export const { FARCASTER_FID, FARCASTER_MNEMONIC, FARCASTER_KEY_REGISTRY_ADDRESS, FARCASTER_WHITELISTED_FIDS } = process.env;
